...
newtesttrian<-merge(newtest,newtrain,all=TRUE) #merging the training & test data#
...
Mean_subject<-acast(Amelt,subject~variable,mean)
Mean_Activity<-acast(Amelt,activity~variable,mean)
