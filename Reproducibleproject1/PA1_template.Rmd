...
Newdata2<-subset(Newdata1,Newdata1$wd=="weekday",select=c(interval,wd,steps))
```

### Plot for weekdays.

```{r}
plot(Newdata2$interval,Newdata2$steps,type="l",lwd="1",
     col="dark red",xlab="Interval", ylab="Number of steps",main="Weekdays average plot")
```

```{r}
Newdata3<-subset(Newdata1,Newdata1$wd=="weekend",select=c(interval,wd,steps))
```

### Plot for weekends.

```{r}
plot(Newdata3$interval,Newdata3$steps,type="l",lwd="1",
     col="dark red",xlab="Interval", ylab="Number of steps",main="Weekends average plot")
```
